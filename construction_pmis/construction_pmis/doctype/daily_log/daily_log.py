...
class DailyLog(Document):
    def autoname(self):
        ...
        self.name = f"DL-{project_abbr}-{current_date_str}-"
    ...
    def populate_from_daily_work_plan(self):
        ...
        self.toolbox_talk_conducted = dwp.safety_precautions # Or link to a specific Toolbox Talk record if that's a DocType
...
class DailyLogManpower(Document):
    pass
...
class DailyLogMaterial(Document):
    pass
