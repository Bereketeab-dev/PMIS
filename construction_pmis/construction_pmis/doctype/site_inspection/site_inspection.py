...
# Child DocType Python Files (minimal, mainly for validation or specific triggers if any)

class SiteInspectionChecklistTemplate(Document):
    def autoname(self):
        # Autoname is field:template_name in JSON
        pass
