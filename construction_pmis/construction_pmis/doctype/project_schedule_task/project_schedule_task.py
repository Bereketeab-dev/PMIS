...
# Child DocType: Project Task Predecessor
class ProjectTaskPredecessor(Document):
    # Belongs to Project Schedule Task
    # Fields:
    # predecessor_task (Link to Project Schedule Task)
    # dependency_type (Select: Finish-to-Start (FS), Start-to-Start (SS), Finish-to-Finish (FF), Start-to-Finish (SF))
    # lag_days (Int)
    pass

# Child DocType: Task Assigned Manpower
class TaskAssignedManpower(Document):
    # Belongs to Project Schedule Task
    # Fields:
    # manpower_plan_item (Link to Manpower Plan Item from Project) - This provides the planned resource
    # OR
    # resource_type (Data, e.g. Carpenter)
    # specific_employee (Link to Employee)
    # quantity (Int)
    # notes (Small Text)
    pass

# Child DocType: Task Assigned Machinery
class TaskAssignedMachinery(Document):
    # Belongs to Project Schedule Task
    # Fields:
    # machinery_plan_item (Link to Machinery Plan Item from Project) - This provides the planned resource
    # OR
    # machinery_asset (Link to Asset)
    # machinery_type (Data)
    # quantity (Int)
    # notes (Small Text)
    pass
