...
class Project(Document):
    def autoname(self):
        if not self.project_name:
            frappe.throw("Project Name is required to generate Project ID.")
        # Example: PROJ-My Awesome Project-001
        # This can be customized further based on specific naming series requirements.
